import { assertExists } from "../simulator/util/assert.js";
import { MemoryAdapter } from "../simulator/cpu/memory.js";
...
export function reduceScreen(memory: MemoryAdapter, offset = 0): ScreenMemory {
  return {
    get(idx: number): number {
...
export const Screen = ({
  ...
  return (
    <article className="panel">
      ...
      {screenScale > 0 && (
        <main style={{ backgroundColor: "var(--code-background-color)", padding: showScaleControls ? undefined : "0" }}>
          <figure
            style={{
              ...
              marginInline: "auto",
              margin: showScaleControls ? "auto" : "0",
